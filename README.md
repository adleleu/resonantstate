...
- **simulation_id** (*int*) unique identifier for a given simulation.
...
Additional columns can be added by the contact person. If so, their name and unit in should be defined in the Readme / additional_info / metadata associated to that analysis.
